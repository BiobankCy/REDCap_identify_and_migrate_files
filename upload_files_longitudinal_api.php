...
#### For longitudinal project, scan the directory with files to be uploaded from the download_files_longitudinal_api.php script, because this script needs the naming convection from download_files_longitudinal_api.php. It includes repeated measurements.
